...
def CSA_PrivBayes_Class(Q, Ax_Pi_distrs, epsilon):  # 敏感属性S，准标识符属性Qi，用maximum joint distribution理论
    a1 = []
    a2 = []
    b1 = []
    b2 = []
...
def build_nosis_distr_HP(k, d, epsilon):
